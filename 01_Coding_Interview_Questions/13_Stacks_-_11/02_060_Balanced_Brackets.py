...
end of the string with some opening brackets that haven't been matched. Can 
you use an auxiliary data structure to keep track of all the brackets and 
...
you check that there are no unmatched opening brackets once you've finished 
