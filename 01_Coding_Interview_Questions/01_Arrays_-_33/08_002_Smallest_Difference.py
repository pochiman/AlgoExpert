...
Hint 3
Start by sorting both arrays, as per Hint #2. Put a pointer at the beginning 
...
otherwise, increment the pointer of the smaller of the two numbers to find 
a potentially better pair. Continue until you get a pair with a difference 
