...
the values of all the nodes that are exactly distance k from the node with target 
value.
...
root node has a left and right child, the left and right children are distance 2 
from each other.
...
tree.  With this information you can perform a breadth-first search starting 
at the target node and traverse through each neighbor (left, right, and parent 
