...
Hint 2
Can you optimize your algorithm by using recursions?  What are the 
...
start with a pointer at the first index of the string and a pointer at the final 
index of the string.  What can you do from there?
